...
Finished early? Try one or more of these challenges — all using only what you know!
...
# Inside your loop, after each valid move:
move_count = move_count + 1
print("Move " + str(move_count) + " of 9")
...
# After each game, update the right counter and display:
print("=== Scoreboard ===")
...
```python
# If the winning line was [0, 4, 8]:
board[0] = board[0].lower()
board[4] = board[4].lower()
board[8] = board[8].lower()
# Then reprint the board
```
